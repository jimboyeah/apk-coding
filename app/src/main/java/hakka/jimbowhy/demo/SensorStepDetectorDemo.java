...
public class SensorStepDetectorDemo extends EventAgent
implements SensorEventListener
{
	...
	public SensorStepDetectorDemo(Activity ctx)
	{
		this(ctx, false);
	}
	public SensorStepDetectorDemo(Activity ctx, Boolean add)
	{
		...
		if( s==null ){
			box.setText(si);
			editor.setText("Sensor not found " + Sensor.STRING_TYPE_STEP_DETECTOR);
		}else{
