...
public class SensorOrientationDemo extends EventAgent
implements SensorEventListener
{
	...
	public SensorOrientationDemo(Activity ctx)
	{
		this(ctx, false);
	}
	public SensorOrientationDemo(Activity ctx, Boolean add)
	{
		...
		if( s==null ){
			box.setText(si);
			editor.setText("Sensor not found " + Sensor.STRING_TYPE_ORIENTATION);
		}else{
	...
	public void onSensorChanged(SensorEvent se)
	{
		...
		String buf = "(Azimuth,Pitch,Roll) of the three physical axes:";
		buf += "\nAll values : " +
