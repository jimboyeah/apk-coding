...
public class SensorStepDemo extends EventAgent
implements SensorEventListener
{
	...
	public SensorStepDemo(Activity ctx)
	{
		this(ctx, false);
	}
	public SensorStepDemo(Activity ctx, Boolean add)
	{
		...
		if( s==null ){
			box.setText(si);
			editor.setText("Sensor not found " + Sensor.STRING_TYPE_STEP_COUNTER);
		}else{
